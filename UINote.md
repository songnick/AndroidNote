#UINote
&emsp;由于当前IOS和Android两个系统的交互设计相互渗透，还有各种炫酷的UI设计。现在也看到很多公司也把能够自定义UI放到招聘要求中，可见我们还是要学习如何去自定义。当然我们自定义UI的过程中，我们对Android系统的一些机制会理解的更加透彻。那么自定义UI真的很难吗，我感觉没有那么难，只要多练习，自然就可以了。按照我的理解，其实我们自定义UI是可以通过这三种方法实现：
